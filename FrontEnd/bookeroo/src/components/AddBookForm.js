...
function inputProps(formik, name, label) {
    return {label, name, onChange: formik.onChange, value: formik.values[name], onBlur: formik.onBlur, error: formik.errors[name], helperText: formik.errors[name]}
}
...
export default function AddBookForm() {
    ...
    return (
        <form onSubmit={formik.handleSubmit}>
            ...
            <TextField {...inputProps(formik, "Publish Date", "publishDate")} type="date" />
            <TextField {...inputProps(formik, "ISBN", "isbn")} />
            <TextField {...inputProps(formik, "Table of Contents", "tableOfContents")} multiline />
        </form>
    )
}